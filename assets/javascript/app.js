$(document).ready(function() {
    ...
    // q parameters for API link to search topic, limit and rating.
      var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + x + "&api_key=yRMYhJC2egsuXoCmFVV3Jb3SUZJCUT9m&limit=10&rating=R";
